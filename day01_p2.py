...
# What is the sum of the fuel requirements for all of the modules on your spacecraft when also taking into account the mass of 
# the added fuel? (Calculate the fuel requirements for each module separately, then add them all up at the end.)

import math

def calculateFuel(mass) :
    quota = mass / 3
    sum = math.floor(quota) - 2

    return sum


fname = "input_day01.txt"
fh = open(fname)
total = 0
